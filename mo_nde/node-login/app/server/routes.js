...
client.on('message', function (topic, message) {
    ...
    console.log(myObject.DeviceInfo[0].DeviceID);
    AM.insertDevice(myObject, function (e, o) {
        if (e) {
            console.log(e);
    ...
    var testId;
    AM.getDevByID("HX7500", function (o) {
        console.log("ooo " + o);
    }); //HX7500
    console.log(testId);
    client.end();
...
module.exports = function (app) {
    ...
    app.get('/DevRegHome', function (req, res) {
        res.render('DevRegHome', {
            title: 'DevRegHome',
            countries: CT
        });
    });
